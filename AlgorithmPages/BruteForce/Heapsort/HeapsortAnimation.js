// Middle Display Panels Animation - Heapsort 
window.loadHeapsort = function () {
    ...
    // Controls the execution of the Heapsort algorithm while recording frames for animation
    ...
    // Heapifies the array and records sorting steps for visualization
    async function heapify(arr, n, i){
        ...
        if (largest !== i){
            swapIndices = [largest, i];
            let temp = arr[i];
            arr[i] = arr[largest];
            arr[largest] = temp;
            appendToExplanation(`Swapped ${arr[largest]} and ${arr[i]}`);
            swapIndices = [];
    ...
    // Enables and contextualizes parts of top control bar relevant to Heapsort
